...
It works well for logic statements with few variables. The algorithm checks 2^(variable_count) conditions to draw a conclusion so it is not very efficient for statements with a lot of variables.
